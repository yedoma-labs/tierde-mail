...
export const NEWSLETTER_CONFIRMATION_STRINGS: NewsletterConfirmationStrings = {
  ...
  body: (listName) =>
    `Click the button below to confirm your subscription to ${listName} updates and newsletters.`,
...
export interface NewsletterConfirmationProps
  extends BaseTemplateProps<NewsletterConfirmationStrings> {
  email: string;
  confirmUrl: string;
...
export const NewsletterConfirmation: EmailTemplateType<NewsletterConfirmationProps> =
  defineEmail<NewsletterConfirmationProps>({

...
export const ORDER_CONFIRMATION_STRINGS: OrderConfirmationStrings = {
  ...
  intro: (orderNumber) => `Thanks for your order! We've received order #${orderNumber} and are getting it ready.`,
  colItem: 'Item',
  colQty: 'Qty',
  colPrice: 'Price',
  totalLabel: 'Total',
...
export const OrderConfirmation: EmailTemplateType<OrderConfirmationProps> = defineEmail<OrderConfirmationProps>({
        ...
        <Section>
          <table style={tableStyle} cellPadding="0" cellSpacing="0">
            ...
            <tbody>
              ...
              <tr>
                <td style={totalRowStyle} colSpan={2}>{s.totalLabel}</td>

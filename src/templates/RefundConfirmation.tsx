...
export const REFUND_CONFIRMATION_STRINGS: RefundConfirmationStrings = {
  ...
  body: (amount) =>
    `We've processed your refund of ${amount}. You should see it back on your original payment method within the timeframe below.`,
  refundIdLabel: 'Refund ID',
  originalOrderLabel: 'Original Order',
  refundToLabel: 'Refund To',
  processingNote: (days) =>
    `Refunds typically appear within ${days} business days, depending on your bank or card issuer.`,
...
export const RefundConfirmation: EmailTemplateType<RefundConfirmationProps> =
  defineEmail<RefundConfirmationProps>({
        ...
        <EmailTemplate preview={s.subject(appName)} lang={locale} dir={dir} theme={theme}>
          ...
          <Section>
            <div style={successBoxStyle}>
              <span
                className="tierde-positive"
                style={{ fontSize: '32px', fontWeight: '800', color: t.successText }}
              >
                {refundAmount}
              </span>
              <p style={{ margin: '4px 0 0', fontSize: '13px', color: t.successText }}>
                {s.heading}
              </p>
            </div>
          </Section>

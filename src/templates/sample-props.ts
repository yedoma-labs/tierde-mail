...
export const SAMPLE_PROPS: Record<string, unknown> = {
  ...
  AppointmentReminder: {
    name: 'Alice Smith',
    providerName: 'Dr. Sarah Müller',
    appointmentDate: 'Wednesday, June 25, 2026',
    appointmentTime: '10:30 AM (Europe/Berlin)',
    location: 'Praxis Mitte, Friedrichstraße 12, 10117 Berlin',
    calendarUrl: 'https://example.com/appointments/abc123/calendar',
    rescheduleUrl: 'https://example.com/appointments/abc123/reschedule',
    cancelUrl: 'https://example.com/appointments/abc123/cancel',
    appName: 'BookEasy',
  },
  EventInvitation: {
    name: 'Alice Smith',
    eventName: 'Building AI-Powered Email Workflows',
    eventDate: 'Thursday, July 10, 2026',
    eventTime: '4:00 PM UTC (60 min)',
    registerUrl: 'https://example.com/events/ai-email-workflows/register',
    description:
      "Join us for a live walkthrough of building production-ready email pipelines with AI. We'll cover template generation, dynamic personalisation, and provider failover.",
    location: 'Live on Zoom (link sent after registration)',
    hostName: 'Acme Engineering',
    calendarUrl: 'https://example.com/events/ai-email-workflows/calendar',
    appName: 'Acme',
  },
  ApiKeyCreated: {
    keyName: 'Production — CI/CD',
    event: 'created',
    manageUrl: 'https://example.com/settings/api-keys',
    maskedKey: 'sk_live_••••••••••••••••••••••••••4d2f',
    expiresAt: 'June 18, 2027',
    appName: 'Acme',
  },
  GiftCard: {
    ...
    message: 'Happy birthday! Hope this helps you grab something nice.',

...
export const REGISTRATION_CONFIRMATION_STRINGS: RegistrationConfirmationStrings = {
  ...
  body: (appName) =>
    `Your account has been created successfully. You're all set to start using ${appName}.`,
  ctaLabel: 'Get Started',
  nextSteps:
    'Complete your profile, explore features, or invite your team to get the most out of your account.',
  footer: (year, appName) => `© ${year} ${appName}. All rights reserved.`,
};

export interface RegistrationConfirmationProps
  extends BaseTemplateProps<RegistrationConfirmationStrings> {
  name: string;
  dashboardUrl: string;
  email?: string;
}

export const RegistrationConfirmation: EmailTemplateType<RegistrationConfirmationProps> =
  defineEmail<RegistrationConfirmationProps>({

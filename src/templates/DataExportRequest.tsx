...
export const DATA_EXPORT_REQUEST_STRINGS: DataExportRequestStrings = {
  ...
  body: (event) => {
    const map: Record<DataExportRequestEvent, string> = {
      requested: 'We received your request to export your personal data. We will begin processing it shortly and notify you when your download is ready.',
      processing: 'We are currently preparing your data export. This usually takes a few minutes. We will send you another email when it is ready.',
      ready: 'Your personal data export is ready to download. The file includes all data associated with your account.',
      expired: 'Your data export download link has expired. You can submit a new export request from your account settings.',
    };
    return map[event];
  },
  ctaLabel: (event) => {
